...
@section('title', 'Add BPH Client Email')

@section('body_class', 'page-bph-client-email-create')
    ...
    <div class="w-full">
        <div class="mb-6 flex flex-wrap items-start gap-4">
            ...
            <div class="min-w-0 flex-1">
                <h1 class="mb-1.5 text-2xl font-bold tracking-tight text-slate-800 dark:text-slate-100">Add BPH client email</h1>
                <p class="text-slate-600 dark:text-slate-400">Save a recipient address for BPH notifications.</p>
            </div>
        </div>
        ...
        <form action="{{ route('bph_client_email.store') }}" method="POST" class="space-y-6" autocomplete="off">
            @csrf

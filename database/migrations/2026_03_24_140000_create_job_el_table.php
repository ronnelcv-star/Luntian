...
{
    /**
     * Efficient Living job table — same shape as legacy `job_bph` (BPH pipeline).
     */
    public function up(): void
    {
        if (Schema::hasTable('job_el')) {
            return;
        }

        Schema::create('job_el', function (Blueprint $table) {
            $table->id();
